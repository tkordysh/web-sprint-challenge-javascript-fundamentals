...
// nestedFunction in this example can access the 'internal' variable because a function inside another function can reach out of its scope
// to access a variable defined in an outer function. This is called a closure. 
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(array){
    const names = [];
    array.map(element => {
    names.push(element.animal_name.toLowerCase())
    });
    return names;
  }; 
  ...
  */
  ...
  function lowPopulationAnimals(array){
      const pops = array.filter(element => element.population < 5)
      return pops;
  };
  ...
  */
  ...
  function USApop(array){
    const totalPop = array.reduce((previousValue, currentValue) => {
      return previousValue + currentValue.population
      }, 0);
      return totalPop;
  }
  console.log('Topic 2, req 4', USApop(zooAnimals));
